...
Ac = AreaComposta()
Ac.append(Circulo("",25,Ponto2D(50,75),Ponto2D(50,75),True))
Ac.append(Retangulo("", 100, 150, Ponto2D(), Ponto2D(50,75), False))
print(Ac.componentes[0].Ix)
print(Ac.componentes[0].Iy)
print(Ac.componentes[1].Ix)
print(Ac.componentes[1].Iy)
print(Ac.area)
print(Ac.centroide.x)
print(Ac.centroide.y)
print(Ac.Ix)
